...
export const SETTINGS_SECTIONS: SettingsSectionMeta[] = [
  ...
  },
  {
    ...
    title: "Code Search",
    description:
      "Semantic indexing of workspace files so the agent (and you) can find code by meaning.",
    icon: FileSearch,
    group: "customization",
    keywords: [
      "code search",
  ...
  },
  {
    ...
    description:
      "Watch live computer usage and background work running for this application.",
    icon: MonitorCog,
    group: "system",
    keywords: [
      "resource",
  ...
  },
  {
    ...
    label: "About",
    title: "About",
    description: "App info, updates, and data management.",
    icon: Info,
    group: "system",
    keywords: [
      "about",
