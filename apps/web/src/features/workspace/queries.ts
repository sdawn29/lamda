...
/**
 * Subagents available to a workspace: the built-ins (general, explore,
 * research) plus any custom agents defined in `~/.lamda/agents` (global) or
 * the workspace's `.lamda/agents` (local).
 */
