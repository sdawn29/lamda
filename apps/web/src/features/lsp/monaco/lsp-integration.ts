...
function syntaxRules(c: CodePalette): editor.ITokenThemeRule[] {
  ...
  return [
    ...
    { token: "keyword.table", foreground: property },
    { token: "keyword.table.header", foreground: property },
    { token: "boolean", foreground: keyword },
    { token: "meta", foreground: comment },
    { token: "meta.content", foreground: comment },
    { token: "meta.separator", foreground: comment },
    { token: "meta.directive", foreground: keyword },
    { token: "operator", foreground: text },
    { token: "operators", foreground: text },
    { token: "operators.directivesEnd", foreground: comment },
    { token: "operators.documentEnd", foreground: comment },
    { token: "delimiter", foreground: text },
    { token: "delimiter.bracket", foreground: text },
    { token: "identifier", foreground: text },
    { token: "variable", foreground: text },
    { token: "variable.source", foreground: string },
    { token: "namespace", foreground: text },
    { token: "string", foreground: string },
    { token: "string.value.json", foreground: string },
    { token: "string.escape", foreground: keyword },
    { token: "string.link", foreground: func },
    { token: "string.target", foreground: func },
    ...
    { token: "number.infinity", foreground: number },
    { token: "number.nan", foreground: number },
    { token: "number.date", foreground: number },
    { token: "constant", foreground: number },
    { token: "enumMember", foreground: number },
    { token: "strong", foreground: keyword, fontStyle: "bold" },
    { token: "emphasis", foreground: parameter, fontStyle: "italic" },
