...
- \`task\` delegates a self-contained piece of work to a subagent whose transcript renders as a collapsible block in the chat, keeping its tool churn out of your context. Prefer it for broad codebase exploration, research across many files, and independent side tasks you can fan out in parallel; do quick, targeted lookups yourself.
